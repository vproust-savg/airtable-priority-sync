...
OUTPUT_FILE_PATH = '/Users/victorproust/Documents/Work/Priority/EDI/21. EDI_Vendors_Financial_Parameters.txt'
...
class EDIProcessor:
    ...
    def create_backup(self) -> None:
        ...
        if self.output_path.exists():
            ...
            backup_filename = f'21. EDI_Vendors_Financial_Parameters_backup_{int(time.time())}.txt'
    ...
    def process_all_data(self) -> List[str]:
        ...
        # Define table configurations for Financial Parameters
        table_configs = [
            {
                'table': 'Vendors',
                'view': 'EDI Vend. Financial 1 - Financial Parameters for Vendors',
                'fields': [
                    'EDI 1', 'Priority Vendor ID', 'Currency', 'Priority Vendor Account No',
                    'Buyer Output', 'Status', 'FDA Registration #', 'Federal Tax ID (16)',
                    'VAT Code', 'Payment Terms Code', 'Maximum Tax Code'
                ]
            },
            {
                'table': 'Vendors',
                'view': 'EDI Vend. Financial 2 - Bank Account Details',
                'fields': [
                    'EDI 2', 'Priority Vendor ID', 'Bank Account', 'Bank Code',
                    'Routing Number', 'IBAN'
                ]
            }
        ]
