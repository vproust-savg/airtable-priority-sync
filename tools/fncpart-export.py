...
OUTPUT_FILE_PATH = '/Users/victorproust/Documents/Work/Priority/EDI/11. EDI_Products_Financial Parameters.txt'
...
class EDIProcessor:
    ...
    def create_backup(self) -> None:
        ...
        if self.output_path.exists():
            ...
            backup_filename = f'11. EDI_Products_Financial Parameters_backup_{int(time.time())}.txt'
    ...
    def process_all_data(self) -> List[str]:
        ...
        table_configs = [
            {
                'table': 'Products',
                'view': 'EDI Financ. Parts 1 - Financial Parameters',
                'fields': [
                    'EDI 1', 'SKU Trim (EDI)', 'Accounting Family', 'Filemaker Gross Weight',
                    'Filemaker Weight', 'HTS Code', 'Shipping Cost Type', 'Country of Origin',
                    'Pallet TI', 'Pallet HI', 'Case / Pallet','Tax_Group_Code'
                ]
            }
        ]
