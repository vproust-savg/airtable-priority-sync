...
P2A_FIELD_MAP: list[FieldMapping] = [
    ...
    FieldMapping(airtable_field="Case Pack", priority_field="SPEC1", transform="to_float", field_type="float"),
    FieldMapping(airtable_field="Product Net Weight Input", priority_field="SPEC2", transform="to_float", field_type="float"),
    FieldMapping(airtable_field="Product Net Weight Unit Input", priority_field="SPEC3", transform="clean"),
    FieldMapping(airtable_field="Brand", priority_field="SPEC4", transform="clean"),
    FieldMapping(airtable_field="Kelsey_Categories", priority_field="SPEC5", transform="clean"),
    FieldMapping(airtable_field="Kelsey_Subcategories", priority_field="SPEC6", transform="clean"),
    FieldMapping(airtable_field="Catalog Status", priority_field="SPEC7", transform="clean"),
    FieldMapping(airtable_field="Inventory Status", priority_field="SPEC8", transform="clean"),
    FieldMapping(airtable_field="Perishable", priority_field="SPEC9", transform="clean"),
    FieldMapping(airtable_field="Retail", priority_field="SPEC10", transform="clean"),
    FieldMapping(airtable_field="Feature_Individual Portions", priority_field="SPEC11", transform="clean"),
    FieldMapping(airtable_field="Staff Pick", priority_field="SPEC12", transform="clean"),
    FieldMapping(airtable_field="Storage", priority_field="SPEC13", transform="clean"),
    # NOTE: Availability Priority Output (SPEC14) is a FORMULA in Airtable — can't write
    FieldMapping(airtable_field="Direct Import", priority_field="SPEC15", transform="clean"),
    # ── Standard LOGPART fields ─────────────────────────────────────────────
    ...
    FieldMapping(airtable_field="Priority Status", priority_field="STATDES", transform="clean"),
    FieldMapping(airtable_field="Type (P/R/O)", priority_field="TYPE", transform="clean"),
]
